...
let { Application, loader, Container, TextStyle, Text, Graphics, Texture } = PIXI;
...
let gameScene;
let startingScene;
let foodTilesetTexture;
let knightTilesetTexture;
let livesText;
...
function createStartingScene() {
    let startingScene = new FixedContainer(app.renderer.width, app.renderer.height, 0x05b384);
...
function createGameScene() {
    let gameScene = new FixedContainer(app.renderer.width, app.renderer.height, 0xef476f);
    let style = new TextStyle({
        fontFamily: "Futura",
        fontSize: 64,
        fill: "white",
...
function createGameOverScene() {
    let gameOverScene = new FixedContainer(app.renderer.width, app.renderer.height, 0x1d3f5e);
